	...
	<>
		<HomeSection>
			...
			<StyledParagraph>
				...
				a zkušenosti nejen s kolegy a přáteli, ale i s lidmi, s nimi nás
				spojuje pouze láska ke světu IT. Online prostředí ovše nedokáže
				nahradit to, co následuje po přednáškách. Ty okamžiky kdy si
				můžeme společně zanadávat na sto a jeden bug vtírající do našeho
				kódu a kdy se u piva dohadujeme, který jazyk to d nejlépe. A to
				je [: aj tý :] spojka - online networking pr programátory,
				podnět k produktivní prokrastinaci uprostřed další karantény a
		...
		<HomeSection>
			<StyledParagraph>
				...
				případě, že se vám někteří uživatelé zalíbí, jim pošlete žádos o
				spojení doplněnou o krátkou personalizovanou zprávu.Dalš krok je
				na nich - musí potvrdit, že se s vámi také chtě spojit. Teprve
				poté, co je spojení potvrzeno, se vám vzájemně zviditelní
				kontaktní údaje.
				<br />
				<br />
